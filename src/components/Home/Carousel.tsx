      ...
      <div className="absolute inset-0 z-40 flex items-center justify-center md:justify-start pl-0 md:pl-8 lg:pl-16">
        <div className="flex flex-col items-center space-y-4 md:space-y-6">
          ...
          >
            ...
            <motion.button
              className="relative bg-white/95 hover:bg-white text-pink-600 border-2 border-white px-6 py-3 md:px-10 md:py-4 rounded-full text-base md:text-lg lg:text-xl font-semibold shadow-lg"
              whileHover={{ scale: 1.05, y: -5 }}
              whileTap={{ scale: 0.95 }}
              type="button"
              onClick={() => {
